                  ...
                  >
                    ...
                    >
                      ...
                      <Box
                        ...
                        className="sellerBox"
                      >
                        <Box className="sellerImg" sx={{ width: "60px" }}>
                          <img
                            style={{ width: "100%" }}
                            src={data?.photos[0].secure_url}
                            alt=""
                          />
                        </Box>
                        ...
                        <Box className="sellerbtn" component={"div"} onClick={messageSeller}> 
