      ...
      <Route path={"/"}>
        ...
        <Route element={<Pages.Auth.ProtectedRoute.Component />}>
          ...
          <Route path="seller">
            ...
            <Route
              path="featured"
              element={<Pages.Featured.Component />}
            />
            <Route
        ...
        <Route element={<AdminroueteWrapper />}>
          <Route element={<AdminWrapper />}>
            ...
            <Route
            path="admininformation" element={<Pages.AdminInformation.Component />} />
            <Route
            path="admininformation/text" element={<Pages.AdminInformationtext.Component />} />
          </Route>
        </Route>
      </Route>
    </Route>
